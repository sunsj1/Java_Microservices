...
public class UserJPAResource {
	...
	public ResponseEntity<Object> createUser(@Valid @RequestBody User user) {
	  ...
	  retrieveAllUsers(@PathVariable int id) { Optional<User> userOptional =
	  ...
	  @PostMapping("/jpa/users/{id}/posts") public ResponseEntity<Object>
	  createPost(@PathVariable int id, @RequestBody Post post) {
